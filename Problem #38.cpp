...
//
//enStatusNumber IsOddNumber(const short number) 
//{
//	if (number % 2 != 0)
...
//}
//
//void AddOddNumbersInArray(short newArray[], short oldArray[], short length, short& length2)
//{
//	for (short i = 0; i < length; i++)
//	{
//		if(IsOddNumber(oldArray[i]) == enStatusNumber::Odd)
...
//
//	AddOddNumbersInArray(array2, array1, length, lengthArray2);
//
//	PrintArray(array1, length, "Array 1 Elements : ");
//
//	PrintArray(array2, lengthArray2, "Array 2 Odd Numbers : ");
//
//	return 0;
//}
