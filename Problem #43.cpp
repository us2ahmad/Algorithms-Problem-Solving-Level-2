...
//}
//
//short GetCountEvenNumbersInArray(short arr[], short length)
//{
//	short counter = 0;
//	for (short i = 0; i < length; i++)
//	{
//		if (GetStatusNumber(arr[i]) == enStatusNumber::Even)
//			counter++;
//	}
//	return counter;
//}
...
//
//	cout << "Even Numbers Count is : " << GetCountEvenNumbersInArray(array1, length);
//
//	return 0;
//}
